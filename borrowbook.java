...
public class borrowbook extends javax.swing.JFrame {
    ...
    public void borrowbook_load()
    {
        int c;
        
        try {
            pst = (PreparedStatement) con.prepareStatement("select * from borrowbook");
            rs = pst.executeQuery();
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Screenshot 2025-05-25 214927.png"))); // NOI18N
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txtbookname, javax.swing.GroupLayout.DEFAULT_SIZE, 110, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            pst = (PreparedStatement) con.prepareStatement("insert into borrowbook(bookname,author,category)values(?,?,?)");
            ...
            if(k== 1)
            {
                JOptionPane.showMessageDialog(this, "borrowbook createdd");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            pst = (PreparedStatement) con.prepareStatement("update borrowbook set bookname = ?, author = ?, category = ? where id = ?");
            pst.setString(1, bookname);
            pst.setString(2, author);
            pst.setString(3, category);
            pst.setInt(4, id);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            pst = (PreparedStatement) con.prepareStatement("delete from borrowbook WHERE id = ?");
