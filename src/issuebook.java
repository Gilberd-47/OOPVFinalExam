...
public class issuebook extends javax.swing.JFrame {
        ...
        try {
            ...
            while(rs.next())
            {
                ...
                for (int i = 1; i <= c; i++)
                {
                    ...
                    v2.add(rs.getString("issuebookname"));
    ...
    private void initComponents() {
        ...
        jLabel2.setText("issuebook name");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Screenshot 2025-05-25 214927.png"))); // NOI18N
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtissue, javax.swing.GroupLayout.DEFAULT_SIZE, 110, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String issuebookname = txtissue.getText();
        String author = txtauthor.getText();
        String category = txtcategory.getText();
        
        
        try {
            pst = (PreparedStatement) con.prepareStatement("insert into issuebook(issuebookname,author,category)values(?,?,?)");
            pst.setString(1, issuebookname);
            ...
            if(k== 1)
            {
                JOptionPane.showMessageDialog(this, "issuebook createdd");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        txtissue.setText(d1.getValueAt(selectIndex, 1).toString());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            pst = (PreparedStatement) con.prepareStatement("update issuebook set issuebookname = ?, author = ?, category = ? where id = ?");
            pst.setString(1, issuebookname);
            pst.setString(2, author);
            pst.setString(3, category);
            pst.setInt(4, id);
