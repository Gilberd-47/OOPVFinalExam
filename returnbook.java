...
public class returnbook extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            pst = (PreparedStatement) con.prepareStatement("insert into returnbook(bookname,author,category)values(?,?,?)");
            ...
            if(k== 1)
            {
                JOptionPane.showMessageDialog(this, "returnbook createdd");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       ...
       DefaultTableModel d1 = (DefaultTableModel)jTable1.getModel();
        ...
        try {
            pst = (PreparedStatement) con.prepareStatement("update returnbook set bookname = ?, author = ?, category = ? where id = ?");
            pst.setString(1, bookname);
            pst.setString(2, author);
            pst.setString(3, category);
            pst.setInt(4, id);
